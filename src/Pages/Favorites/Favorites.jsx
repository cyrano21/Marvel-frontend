...
// import { getFavorites } from "../../components/storage";
...
//                 onClick={() => removeFromFavorites(character._id)}
//               >
//                 X
//               </button>
//               <img
//                 onClick={() => setZoomedImage(character)}
...
//       </div>
//       {zoomedImage && (
//         <div className="backdrop" onClick={() => setZoomedImage(null)}>
//           <img
//             src={`${zoomedImage.thumbnail.path}.${zoomedImage.thumbnail.extension}`}
